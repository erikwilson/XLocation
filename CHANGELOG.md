...
* [Xposed module repository](http://repo.xposed.info/module/org.thoughtland.xlocation) (stable versions)
...
* Broadcast *org.thoughtland.xlocation.action.EXCEPTION* if the database could not be read ([issue](/../../issues/2081))
* Fixed all problems reported through the debug info
...
* Notify and do not send the intent *org.thoughtland.xlocation.action.ACTIVE* when the privacy database was corrupt (discussed on XDA)
